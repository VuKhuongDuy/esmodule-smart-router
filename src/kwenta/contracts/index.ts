...
import DappMaintenanceABI from './abis/DappMaintenance.json' assert { type: "json" }
import ERC20ABI from './abis/ERC20.json' assert { type: "json" } 
import ExchangeRatesABI from './abis/ExchangeRates.json' assert { type: "json" }
import FuturesMarketDataABI from './abis/FuturesMarketData.json' assert { type: "json" }
import FuturesMarketSettingsABI from './abis/FuturesMarketSettings.json' assert { type: "json" }
import KwentaArrakisVaultABI from './abis/KwentaArrakisVault.json' assert { type: "json" }
import KwentaStakingRewardsABI from './abis/KwentaStakingRewards.json' assert { type: "json" }
import KwentaStakingRewardsV2ABI from './abis/KwentaStakingRewardsV2.json' assert { type: "json" }
import MultipleMerkleDistributorABI from './abis/MultipleMerkleDistributor.json' assert { type: "json" }
import MultipleMerkleDistributorOpABI from './abis/MultipleMerkleDistributorOp.json' assert { type: "json" }
import MultipleMerkleDistributorPerpsV2ABI from './abis/MultipleMerkleDistributorPerpsV2.json' assert { type: "json" }
import PerpsV2MarketABI from './abis/PerpsV2Market.json' assert { type: "json" }
import PerpsV2MarketDataABI from './abis/PerpsV2MarketData.json' assert { type: "json" }
import PerpsV2MarketSettingsABI from './abis/PerpsV2MarketSettings.json' assert { type: "json" }
import RewardEscrowABI from './abis/RewardEscrow.json' assert { type: "json" }
import RewardEscrowV2ABI from './abis/RewardEscrowV2.json' assert { type: "json" }
import StakingRewardsABI from './abis/StakingRewards.json' assert { type: "json" }
import SupplyScheduleABI from './abis/SupplySchedule.json' assert { type: "json" }
import SynthRedeemerABI from './abis/SynthRedeemer.json' assert { type: "json" }
import SystemStatusABI from './abis/SystemStatus.json' assert { type: "json" }
...
type ContractFactory = {
	connect: (address: string, provider: ethersPkg.providers.Provider) => ethersPkg.Contract
}
...
export const getContractsByNetwork = (
	networkId: NetworkId,
	provider: ethersPkg.providers.Provider
) => {
	return {
